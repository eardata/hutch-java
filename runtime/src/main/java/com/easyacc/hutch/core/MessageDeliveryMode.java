...
/**
 * Enumeration for the message delivery mode. Can be persistent or non persistent. Use the method
 * 'toInt' to get the appropriate value that is used by the AMQP protocol instead of the ordinal()
