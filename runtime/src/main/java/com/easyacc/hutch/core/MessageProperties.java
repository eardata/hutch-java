...
public class MessageProperties implements Serializable {
  ...
  @Serial private static final long serialVersionUID = 1619000546531112290L;
  ...
  public String getReplyToAddress() {
    return (this.replyTo != null) ? this.replyTo : null;
  }
  ...
  /**
   * When a delayed message exchange is used the x-delay header on a received message contains the
   * delay.
   *
  ...
  /**
   * Return the server's most recent estimate of the number of messages remaining on the queue. Only
   * applies to messages retrieved via {@code basicGet}.
   *
   * @return the count.
   */
  ...
  /**
   * The inferred target argument type when using a method-level {@code @RabbitListener}.
   *
   * @return the type.
   * @since 1.6
   */
  ...
  /**
   * Set the inferred target argument type when using a method-level {@code @RabbitListener}.
   *
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((this.contentEncoding == null) ? 0 : this.contentEncoding.hashCode());
    ...
    result =
        prime * result + ((this.receivedExchange == null) ? 0 : this.receivedExchange.hashCode());
    result =
        prime * result
            + ((this.receivedRoutingKey == null) ? 0 : this.receivedRoutingKey.hashCode());
  ...
  public String toString() {
    return "MessageProperties [headers="
        ...
        + (this.receivedDeliveryMode == null
            ? ""
